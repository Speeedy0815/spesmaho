...
public:
	...
	void     init(int8_t restpin, int8_t csPin, uint8_t tc = TAB_COLOUR), begin(int8_t restpin, int8_t csPin, uint8_t tc = TAB_COLOUR);
...
private:
	...
	/*void CS_L() { GPIO.out_w1tc = (1 << _csPin); GPIO.out_w1tc = (1 << _csPin); };

	void CS_H() { GPIO.out_w1ts = (1 << _csPin); GPIO.out_w1ts = (1 << _csPin);};*/
	void CS_L() { GPIO.out_w1tc = (1 << _csPin); GPIO.out_w1tc = (1 << _csPin); };

	void CS_H() { GPIO.out_w1ts = (1 << _csPin); };
	
	//void CS_L() { digitalWrite(_csPin,LOW); };

	//void CS_H() { digitalWrite(_csPin, HIGH); }; 
